...
import org.socialhistoryservices.delivery.reservation.util.DateUtils;
...
public class ReservationController extends AbstractRequestController {
    ...
    public String get(HttpServletRequest req, Model model) {
        ...
        // Fetch result set
        List<HoldingReservation> holdingReservations =
                reservations.listHoldingReservations(cq, getFirstResult(p), getMaxResults(p));
    ...
    public String showCreateForm(HttpServletRequest req, @PathVariable String path,
                                 @RequestParam(required = false) String[] codes, Model model) {
        ...
        return processVisitorReservationCreation(req, newRes, null, codes, model, false);
    }
    ...
    public String processCreateForm(HttpServletRequest req, @ModelAttribute("reservation") Reservation newRes,
                                    BindingResult result, @RequestParam(required = false) String[] codes, Model model) {
        return processVisitorReservationCreation(req, newRes, result, codes, model, true);
    }

    private String processVisitorReservationCreation(HttpServletRequest req, Reservation newRes, BindingResult result,
                                                     String[] codes, Model model, boolean commit) {
    ...
    public String showMassCreateForm(@RequestParam(required = false) Integer fromReservationId, Model model) {
        Reservation newRes = new Reservation();
